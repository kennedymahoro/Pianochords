  ...
  return (
    <div className="p-8 grid gap-8">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>How to play piano chords?</CardTitle>
          </CardHeader>
          <CardContent>
